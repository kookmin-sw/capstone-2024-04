...
public class MediaController {
    ...
    public ResponseEntity<APIResponse<MediaApplicationResponse.TotalApplicationInfo>> createMedia(@RequestPart(value = "request") @Valid MediaRequest.Create create, @RequestPart(value = "file",required = false) MultipartFile multipartFile, @AuthenticationPrincipal CustomUserDetails userDetails){
        ...
        MediaApplicationResponse.TotalApplicationInfo applicationInfo = new MediaApplicationResponse.TotalApplicationInfo(media, mediaApplication);
